...
define("EW_PROJECT_NAME", "IrcioGauge2", TRUE); // Project name
define("EW_RANDOM_KEY", 'sPi9BemNZ5F8Bmwn', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "IrcioGauge2.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_HOST", '*********', TRUE);
//define("EW_CONN_PORT", 3306, TRUE);
define("EW_CONN_USER", '****', TRUE);
...
$EW_LANGUAGE_FILE[] = array("", "", "spanish.XML");
define("EW_LANGUAGE_DEFAULT_ID", "", TRUE);
